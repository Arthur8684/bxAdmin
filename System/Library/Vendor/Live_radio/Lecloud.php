...
class Lecloud{
	 ...
	 public $live_apiurl = 'http://api.open.letvcloud.com/live/execute';//直播接口地址
	 public $play_apiurl = 'http://api.letvcloud.com/open.php';//点播接口地址
	 public $live_ver = '4.0';//直播协议版本
	 public $play_ver = '2.0';//点播协议版本
	
    function __construct($userid,$AppSecret,$uuid,$live_ver='4.0',$play_ver = '2.0') {
		$this->UserId = $userid;
