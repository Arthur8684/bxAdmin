...
* $var_array     已有变量的值
*/    
   function create_form_field_by_table($table,$id,$formid,$var_array,$group="")
   {
       if(!$table) return "";
       if(is_numeric($table))
		{
...
/*============================验证字段的权限===========================================*/
				...
				else
				{
					   ...
					   if($v['setting']['data2'] && $v['setting']['sql'] && $v['setting']['sql_var'] && !$id)
						...
						//////////////////////////////////////////////////////////////
						if(!$v['setting']['data0'] && $v['form_type']!="image" && $v['form_type']!="images" && $v['form_type']!="datetime")
						{
						...
						{
						    if(isMobile()) $v['tem_c']=($v['tem_mobile_c']?$v['tem_mobile_c']:$v['tem_c']);
							$patterns=array('/\[title]/i','/\[field]/i','/\[remarks]/i');
