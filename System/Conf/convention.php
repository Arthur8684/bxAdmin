...
return  array(
    ...
    'COOKIE_PREFIX'         =>  'BB_',      // Cookie前缀 避免冲突
    ...
    'SESSION_OPTIONS'       =>  array('name'=>'session_id','expire'=>259200), // session 配置数组 支持type name id path expire domain 等参数
    'SESSION_TYPE'          =>  '', // session hander类型 默认无需设置 除非扩展了session hander驱动
    'SESSION_PREFIX'        =>  'BB_', // session 前缀
    ...
    'TAGLIB_BUILD_IN'       =>  'cx,TagLibDiy', // 内置标签库名称(标签使用不必指定标签库名称),以逗号分隔 注意解析顺序
