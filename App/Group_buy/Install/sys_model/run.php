<?php 
    $menu_id=add_menu(array('title'=>$_POST['name'].L('SYSTEM'),'url_m'=>'Group_buy','parent_id'=>3,'model_id'=>$insert_id,'type'=>'admin','status'=>1,'sort'=>2));
	...
	add_menu(array('title'=>"内容管理",'url_m'=>'Group_buy','url_c'=>'Groupbuy','url_a'=>'group_buy_list','url_p'=>'modelid='.$insert_id,'type'=>'admin','parent_id'=>$menu_id,'model_id'=>$insert_id,'status'=>1,'sort'=>2));
	load('Field/function');
	...
	add_auth(array('title'=>"内容管理",'name'=>'Group_buy/Groupbuy/group_buy_list?modelid='.$insert_id,'auth_m'=>'Group_buy','auth_c'=>'Groupbuy','auth_a'=>'group_buy_list','auth_p'=>'modelid='.$insert_id,'class_id'=>$class_id,'status'=>1,'sort'=>0));
	add_auth(array('title'=>"添加信息",'name'=>'Group_buy/Groupbuy/group_buy_add?modelid='.$insert_id,'auth_m'=>'Group_buy','auth_c'=>'Groupbuy','auth_a'=>'group_buy_add','auth_p'=>'modelid='.$insert_id,'class_id'=>$class_id,'status'=>1,'sort'=>1));
	add_auth(array('title'=>"删除信息",'name'=>'Group_buy/Groupbuy/group_buy_del?modelid='.$insert_id,'auth_m'=>'Group_buy','auth_c'=>'Groupbuy','auth_a'=>'group_buy_del','auth_p'=>'modelid='.$insert_id,'class_id'=>$class_id,'status'=>1,'sort'=>2));
	add_auth(array('title'=>"编辑信息",'name'=>'Group_buy/Groupbuy/group_buy_edit?modelid='.$insert_id,'auth_m'=>'Group_buy','auth_c'=>'Groupbuy','auth_a'=>'group_buy_edit','auth_p'=>'modelid='.$insert_id,'class_id'=>$class_id,'status'=>1,'sort'=>3));
