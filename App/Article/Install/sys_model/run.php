<?php 
    $menu_id=add_menu(array('title'=>$_POST['name'].L('SYSTEM'),'url_m'=>'Article','parent_id'=>3,'model_id'=>$insert_id,'type'=>'admin','status'=>1,'sort'=>2));
	...
	add_menu(array('title'=>"内容管理",'url_m'=>'Article','url_c'=>'Article','url_a'=>'article_list','url_p'=>'modelid='.$insert_id,'type'=>'admin','parent_id'=>$menu_id,'model_id'=>$insert_id,'status'=>1,'sort'=>2));
	load('Field/function');
	...
	add_auth(array('title'=>"内容管理",'name'=>'article/aticle/article_list?modelid='.$insert_id,'auth_m'=>'article','auth_c'=>'aticle','auth_a'=>'article_list','auth_p'=>'modelid='.$insert_id,'class_id'=>$class_id,'status'=>1,'sort'=>0));
	add_auth(array('title'=>"添加信息",'name'=>'article/aticle/article_add?modelid='.$insert_id,'auth_m'=>'article','auth_c'=>'aticle','auth_a'=>'article_add','auth_p'=>'modelid='.$insert_id,'class_id'=>$class_id,'status'=>1,'sort'=>1));
	add_auth(array('title'=>"删除信息",'name'=>'article/aticle/article_del?modelid='.$insert_id,'auth_m'=>'article','auth_c'=>'aticle','auth_a'=>'article_del','auth_p'=>'modelid='.$insert_id,'class_id'=>$class_id,'status'=>1,'sort'=>2));
	add_auth(array('title'=>"编辑信息",'name'=>'article/aticle/article_edit?modelid='.$insert_id,'auth_m'=>'article','auth_c'=>'aticle','auth_a'=>'article_edit','auth_p'=>'modelid='.$insert_id,'class_id'=>$class_id,'status'=>1,'sort'=>3));
