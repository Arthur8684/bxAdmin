...
var App = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        $('.nav').on('click', '.sidebar-toggler', function (e) {            
            var body = $('body');
            var sidebar = $('.page-sidebar');
    ...
    var handleTabs = function () {
		...
		if(location.hash) {
			...
			var tab_array=tabid.split("-");//
			var str_value='';
			for (var k = 0, length = tab_array.length; k < length; k++) {
                 str_value=str_value?str_value+"-"+tab_array[k]:tab_array[k];
				 $('a[href="#'+str_value+'"]').click();
            }  
        }
    }
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "/public/css_js_font_img/css/public/" + color + ".css");
        ...
        $('li', color_set).click(function () {
            var color = $(this).attr("data-style");
            setColor(color);
            $('.inline li', color_set).removeClass("current");
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="./public/css_js_font_img/img/public/ajax-loading.gif" align="">',
